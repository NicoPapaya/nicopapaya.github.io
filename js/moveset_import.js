...
function movePatch(inMove) {
	var swap = {
		"Acid Armor": "Fire Lash",
		"Acupressure": "Triple Axel",
		"Assist": "Raging Fury",
		"Barrage": "Headlong Rush",
		"Barrier": "Mystical Fire",
		"Bind": "Weather Ball W",
		"Bubble": "Liquidation",
		"Charge": "Plasma Fists",
		"Clamp": "HP Water",
		"Comet Punch": "HP Dark",
		"Constrict": "Jet Punch",
		"Double Slap": "Weather Ball F",
		"Fake Tears": "Kowtow Cleave",
		"Fire Spin": "HP Fire",
		"Focus Energy": "Flip Turn",
		"Fury Attack": "Weather Ball I",
		"Grass Whistle": "Surging Strikes",
		"Horn Attack": "HP Dragon",
		"Ice Ball": "HP Ice",
		"Iron Defense": "HP Steel",
		"Lick": "HP Ghost",
		"Lock-On": "Smart Strike",
		"Lunar Dance": "Esper Wing",
		"Luster Purge": "HP Psychic",
		"Metal Sound": "Boomburst",
		"Mist Ball": "Moonblast",
		"Mud Sport": "High Horsepower",
		"Mud-Slap": "HP Ground",
		"Peck": "HP Flying",
		"Pin Missile": "HP Bug",
		"Pound": "HP Normal",
		"Psywave": "HP Fairy",
		"Refresh": "Oblivion Wing",
		"Rock Throw": "HP Rock",
		"Rolling Kick": "HP Fighting",
		"Rollout": "Accelerock",
		"Scary Face": "Psychic Fangs",
		"Sharpen": "Lunge",
		"Slam": "Scorching Sands",
		"Smog": "HP Poison",
		"SmokeScreen": "Nuzzle",
		"Spider Web": "First Impression",
		"Sweet Scent": "Wave Crash",
		"Thunder Shock": "HP Electric",
		"Vine Whip": "HP Grass",
		"Withdraw": "Dazzling Gleam",
		"Wrap": "Weather Ball R",
	};
	if (swap[inMove] != null) {
		return swap[inMove];
